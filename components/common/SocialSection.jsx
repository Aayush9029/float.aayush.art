      ...
      <Grid columns={{ xs: 1, md: 2, lg: 4}} gap>
        <GridItem>
          <Stack gap={1} align="center" style={{ textAlign: 'center' }}>
            ...
            <Typography variant="body-reduced">
              Stay in the know! Follow us @FloatApp on Twitter to get the
              latest updates.
            </Typography>
        ...
        <GridItem>
          <Stack gap={1} align="center" style={{ textAlign: 'center' }}>
            ...
            <Typography variant="body-reduced">
              Some of the best ideas come from our community. Join us to influence Float.
            </Typography>
        ...
        <GridItem>
          <Stack gap={1} align="center" style={{ textAlign: 'center' }}>
            ...
            <Typography variant="body-reduced">
              Help shape the future of Float. Submit an issue or become a contributor today.
            </Typography>
