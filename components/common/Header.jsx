        ...
        <HeaderContainer>
          ...
          <Menu>
            ...
            <Actions>
              <Action>
                <label
                  htmlFor="Floatnav-menustate"
                  className="Floatnav-menucta"
                >
                  <span className="Floatnav-menucta-chevron"></span>
                </label>
              </Action>
              <Action>
                <a>
                  <Button compact  onClick={() => window.open("https://apps.apple.com/us/app/float-floating-web-browser/id1621142916")} >Download Now</Button>
                </a>
              </Action>
            </Actions>
          </Menu>
